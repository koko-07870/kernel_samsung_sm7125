...
enum dsi_cmd_set_type {
	...
	TX_ISC_DEFECT_TEST_ON,//163
	TX_ISC_DEFECT_TEST_OFF,//164

	/* SELF DISPLAY */
	TX_SELF_DISP_CMD_START,//165
	TX_SELF_DISP_ON,
	TX_SELF_DISP_OFF,
	TX_SELF_TIME_SET,
	TX_SELF_MOVE_ON,
